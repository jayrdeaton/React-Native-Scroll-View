...
describe('SectionList', () => {
  ...
  it('renders without crashing', () => {
    render(<SectionList sections={sections} renderItem={({ item }) => <>{item}</>} keyExtractor={(item) => item} />, { wrapper })
  })

  it('renders with renderSectionHeader', () => {
    render(<SectionList sections={sections} renderItem={({ item }) => <>{item}</>} keyExtractor={(item) => item} renderSectionHeader={({ section }) => <>{(section as Section).title}</>} />, { wrapper })
  })
  ...
  it('renders with pullSearchHeight', () => {
    render(<SectionList sections={sections} renderItem={({ item }) => <>{item}</>} keyExtractor={(item) => item} pullSearchHeight={60} />, { wrapper })
  })

  it('renders with renderFilters', () => {
    render(<SectionList sections={sections} renderItem={({ item }) => <>{item}</>} keyExtractor={(item) => item} renderFilters={<></>} />, { wrapper })
  })
})
